 ...
 * @property {boolean} [optimizeCss=false] For type `webapp`: If `true`, `optimize-css-assets-webpack-plugin` will be used to minify output CSS. If typeof `object`, this will be used as configuration for OptimizeCssAssetsPlugin constructor.
 ...
 * @property {boolean} [friendlyErrors=false] If `true`, includes `friendly-errors-webpack-plugin`
