...
```bash
npm install --save-dev webpack-config-jaid@^11.12.2
```
...
```bash
yarn add --dev webpack-config-jaid@^11.12.2
```
...
```bash
npm install --save-dev @jaid/webpack-config-jaid@^11.12.2
```
