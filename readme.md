...
```bash
npm install --save-dev webpack-config-jaid@^11.12.0
```
...
```bash
yarn add --dev webpack-config-jaid@^11.12.0
```
...
```bash
npm install --save-dev @jaid/webpack-config-jaid@^11.12.0
```
