...
```bash
npm install --save-dev webpack-config-jaid@^11.7.1
```
...
```bash
yarn add --dev webpack-config-jaid@^11.7.1
```
...
```bash
npm install --save-dev @jaid/webpack-config-jaid@^11.7.1
```
