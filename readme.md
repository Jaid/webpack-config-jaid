...
```bash
npm install --save-dev webpack-config-jaid@^11.12.3
```
...
```bash
yarn add --dev webpack-config-jaid@^11.12.3
```
...
```bash
npm install --save-dev @jaid/webpack-config-jaid@^11.12.3
```
